...
const Info:React.FC<Props> = ({title,description,id,price,color,size, inventory,userId,store,rating,numbercomments}) => {
  ...
  return (
    <div className='relative info'>
        ...
        <h3 className='text-md text-neutral-500'>In Stock:<span className='font-bold'> {inventory}</span></h3>
