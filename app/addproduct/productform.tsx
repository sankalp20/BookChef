...
const Productform = (props: Props) => {
  ...
  return (
    <div className='px-5 max-w-[1280px] mx-auto mb-10'>
        ...
        <h1 className='text-3xl font-semibold py-6'>Add your Product in BookChef</h1>
        <div className='text-black mt-4'>
            <div className='grid md:grid-cols-2 grid-cols-1 gap-5'>
                ...
                <div>
                    <label htmlFor="style" className='font-medium'>Author</label>
                    <input 
                        type="text"
                        className='w-full h-[50px] border-[1px] rounded-lg focus:border-pink-500 px-3 focus:border-2 outline-none'
                        name='style'
                ...
                <div>
                    <label htmlFor="store" className='font-medium'>Year of Publishing</label>
                    <input 
                        type="text"
                        className='w-full h-[50px] border-[1px] rounded-lg focus:border-pink-500 px-3 focus:border-2 outline-none'
                        name='store'
