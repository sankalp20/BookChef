        ...
        <div className='relative'>
            <div className={`md:w-[250px] border-l-[0.5px] border-r-[0.5px] ${showFilter ? "max-md:w-[250px]":"w-0 max-md:invisible"}`}>
                ...
                <div className='flex flex-col py-3 pb-5 tet-sm text-neutral-600 border-b-[0.5px]'>
                    <span
                        className={`py-3 px-5 ${props.selectedCategories.includes('Novel') ? "bg-purple-50":""}`}
                        onClick={() => toggleCategory('Novel')}
                    >
                        Novel
                    </span>
                    <span
                        className={`py-3 px-5 ${props.selectedCategories.includes('Literary') ? "bg-purple-50":""}`}
                        onClick={() => toggleCategory('Literary')}
                    >
                        Literary
                    </span>
                    <span
                        className={`py-3 px-5 ${props.selectedCategories.includes('Biography') ? "bg-purple-50":""}`}
